...
const SixPlayerCard = (props) => {
  ...
  const addMargins = (() => {
    if (layout === 1) {
      ...
      if (player === 2 || player === 4) {
        return { marginTop: 10, marginRight: 10 }
      } else if (player === 3 || player === 5 || player === 6) {
        return { marginTop: 10 }
      };
    };
  })();
  ...
  const addPadding = (player === 1 || player === 6) && styles.paddingBottom;
  ...
  return (
    <View style={[setContainerStyles, addFlexBasis]}>
      ...
      >
        <View style={[styles.center, addPadding, handleTextTransform]}>
